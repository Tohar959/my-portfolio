module.exports = [
"[project]/node_modules/enhanced-resolve/lib/getPaths.js [postcss] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/enhanced-resolve/lib/CloneBasenamePlugin.js [postcss] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/enhanced-resolve/lib/LogInfoPlugin.js [postcss] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/enhanced-resolve/lib/forEachBail.js [postcss] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/enhanced-resolve/lib/util/path.js [postcss] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
/** @type {Map<string, string>} */ const dirnameCache = new Map();
/**
 * @param {string} maybePath a path
 * @returns {string} the directory name
 ...
 */ const isSubPath = (parentPath, childPath)=>{
    ...
    const parentWithSlash = parentPath.endsWith("/") || parentPath.endsWith("\\") ? parentPath : normalize(`${parentPath}/`);
...
"[project]/node_modules/enhanced-resolve/lib/AliasUtils.js [postcss] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/enhanced-resolve/lib/ModulesUtils.js [postcss] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
 ...
 */ function modulesResolveHandler(resolver, directories, target, request, resolveContext, callback) {
    ...
    const addrs = getPaths(request.path).paths.map((path)=>directories.map((directory)=>resolver.join(path, directory))).reduce((array, path)=>{
        array.push(...path);
        return array;
    }, []);
    forEachBail(addrs, /**
...
"[project]/node_modules/enhanced-resolve/lib/util/strip-json-comments.js [postcss] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/enhanced-resolve/lib/util/fs.js [postcss] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

/*
	MIT License http://www.opensource.org/licenses/mit-license.php
	Author Natsu @xiaoxiaojx
*/ const stripJsonComments = __turbopack_context__.r("[project]/node_modules/enhanced-resolve/lib/util/strip-json-comments.js [postcss] (ecmascript)");
...
"[project]/node_modules/enhanced-resolve/lib/TsconfigPathsPlugin.js [postcss] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

/*
	MIT License http://www.opensource.org/licenses/mit-license.php
	Author Natsu @xiaoxiaojx
*/ const { aliasResolveHandler } = __turbopack_context__.r("[project]/node_modules/enhanced-resolve/lib/AliasUtils.js [postcss] (ecmascript)");
const { modulesResolveHandler } = __turbopack_context__.r("[project]/node_modules/enhanced-resolve/lib/ModulesUtils.js [postcss] (ecmascript)");
const { readJson } = __turbopack_context__.r("[project]/node_modules/enhanced-resolve/lib/util/fs.js [postcss] (ecmascript)");
const { PathType: _PathType, cachedDirname: dirname, cachedJoin: join, isSubPath, normalize } = __turbopack_context__.r("[project]/node_modules/enhanced-resolve/lib/util/path.js [postcss] (ecmascript)");
...
module.exports = class TsconfigPathsPlugin {
	 ...
	 */ constructor(configFileOrOptions){
        if (typeof configFileOrOptions === "object" && configFileOrOptions !== null) {
            ...
            this.configFile = configFileOrOptions === true ? DEFAULT_CONFIG_FILE : configFileOrOptions;
	 ...
	 */ async _getTsconfigPathsMap(resolver, request, resolveContext) {
        if (typeof request.tsconfigPathsMap === "undefined") {
            try {
                const absTsconfigPath = join(request.path || process.cwd(), this.configFile);
                const result = await this._loadTsconfigPathsMap(resolver.fileSystem, absTsconfigPath);
	 ...
	 */ async _loadTsconfigPathsMap(fileSystem, absTsconfigPath) {
        ...
        const config = await this._loadTsconfig(fileSystem, absTsconfigPath, fileDependencies);
        ...
        const main = tsconfigPathsToResolveOptions(mainContext, compilerOptions.paths || {}, baseUrl);
        ...
        if (Array.isArray(referencesToUse)) {
            await this._loadTsconfigReferences(fileSystem, mainContext, referencesToUse, fileDependencies, refs);
        }
        return {
            main,
            mainContext,
	 ...
	 */ async _loadTsconfigFromExtends(fileSystem, configFilePath, extendedConfigValue, fileDependencies, visitedConfigPaths) {
        ...
        if (!exists && extendedConfigValue.includes("/")) {
            extendedConfigPath = join(currentDir, normalize(`node_modules/${extendedConfigValue}`));
        }
        const config = await this._loadTsconfig(fileSystem, extendedConfigPath, fileDependencies, visitedConfigPaths);
        const compilerOptions = config.compilerOptions || {
            baseUrl: undefined
        };
        if (compilerOptions.baseUrl) {
            const extendsDir = dirname(extendedConfigValue);
            compilerOptions.baseUrl = getAbsoluteBaseUrl(extendsDir, compilerOptions.baseUrl);
        }
	 ...
	 */ async _loadTsconfigReferences(fileSystem, context, references, fileDependencies, referenceMatchMap) {
        for (const ref of references){
            ...
            try {
                const refConfig = await this._loadTsconfig(fileSystem, refConfigPath, fileDependencies);
                if (refConfig.compilerOptions && refConfig.compilerOptions.paths) {
                    const refContext = dirname(refConfigPath);
                    referenceMatchMap[refContext] = tsconfigPathsToResolveOptions(refContext, refConfig.compilerOptions.paths || {}, refConfig.compilerOptions.baseUrl);
                }
                if (this.references === "auto" && Array.isArray(refConfig.references)) {
                    await this._loadTsconfigReferences(fileSystem, dirname(refConfigPath), refConfig.references, fileDependencies, referenceMatchMap);
                }
            } catch (_err) {
                continue;
            }
	 ...
	 */ async _loadTsconfig(fileSystem, configFilePath, fileDependencies, visitedConfigPaths = new Set()) {
        ...
        if (extendedConfig) {
            ...
            if (Array.isArray(extendedConfig)) {
                ...
                for (const extendedConfigElement of extendedConfig){
                    const extendedTsconfig = await this._loadTsconfigFromExtends(fileSystem, configFilePath, extendedConfigElement, fileDependencies, visitedConfigPaths);
                    base = mergeTsconfigs(base, extendedTsconfig);
                }
            } else {
                base = await this._loadTsconfigFromExtends(fileSystem, configFilePath, extendedConfig, fileDependencies, visitedConfigPaths);
            }
...
"[project]/node_modules/enhanced-resolve/lib/util/memoize.js [postcss] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/enhanced-resolve/lib/CachedInputFileSystem.js [postcss] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/enhanced-resolve/lib/DescriptionFileUtils.js [postcss] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/enhanced-resolve/lib/getInnerRequest.js [postcss] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/enhanced-resolve/lib/AliasFieldPlugin.js [postcss] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/enhanced-resolve/lib/AliasPlugin.js [postcss] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
module.exports = class AliasPlugin {
	 ...
	 */ apply(resolver) {
        ...
        resolver.getHook(this.source).tapAsync("AliasPlugin", (request, resolveContext, callback)=>{
            aliasResolveHandler(resolver, this.options, target, request, resolveContext, callback);
        });
    }
};
}),
"[project]/node_modules/enhanced-resolve/lib/AppendPlugin.js [postcss] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/enhanced-resolve/lib/ConditionalPlugin.js [postcss] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/enhanced-resolve/lib/DescriptionFilePlugin.js [postcss] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/enhanced-resolve/lib/DirectoryExistsPlugin.js [postcss] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/enhanced-resolve/lib/util/identifier.js [postcss] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

/*
	MIT License http://www.opensource.org/licenses/mit-license.php
	Author Ivan Kopeykin @vankop
*/ const memorize = __turbopack_context__.r("[project]/node_modules/enhanced-resolve/lib/util/memoize.js [postcss] (ecmascript)");
...
"[project]/node_modules/enhanced-resolve/lib/util/entrypoints.js [postcss] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/enhanced-resolve/lib/ExportsFieldPlugin.js [postcss] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/enhanced-resolve/lib/ExtensionAliasPlugin.js [postcss] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/enhanced-resolve/lib/FileExistsPlugin.js [postcss] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/enhanced-resolve/lib/ImportsFieldPlugin.js [postcss] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/enhanced-resolve/lib/JoinRequestPartPlugin.js [postcss] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/enhanced-resolve/lib/JoinRequestPlugin.js [postcss] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/enhanced-resolve/lib/MainFieldPlugin.js [postcss] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/enhanced-resolve/lib/ModulesInHierarchicalDirectoriesPlugin.js [postcss] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/enhanced-resolve/lib/ModulesInRootPlugin.js [postcss] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/enhanced-resolve/lib/NextPlugin.js [postcss] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/enhanced-resolve/lib/ParsePlugin.js [postcss] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/enhanced-resolve/lib/PnpPlugin.js [postcss] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/enhanced-resolve/lib/createInnerContext.js [postcss] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/enhanced-resolve/lib/Resolver.js [postcss] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
/** @typedef {KnownContext & Record<any, any>} Context */ /** @typedef {import("./AliasUtils").AliasOption} AliasOption */ /** @typedef {Error & { details?: string }} ErrorWithDetail */ /** @typedef {(err: ErrorWithDetail | null, res?: string | false, req?: ResolveRequest) => void} ResolveCallback */ /**
...
"[project]/node_modules/enhanced-resolve/lib/RestrictionsPlugin.js [postcss] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/enhanced-resolve/lib/ResultPlugin.js [postcss] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/enhanced-resolve/lib/RootsPlugin.js [postcss] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/enhanced-resolve/lib/SelfReferencePlugin.js [postcss] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/enhanced-resolve/lib/SymlinkPlugin.js [postcss] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/enhanced-resolve/lib/SyncAsyncFileSystemDecorator.js [postcss] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/enhanced-resolve/lib/TryNextPlugin.js [postcss] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/enhanced-resolve/lib/UnsafeCachePlugin.js [postcss] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/enhanced-resolve/lib/UseFilePlugin.js [postcss] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/enhanced-resolve/lib/ResolverFactory.js [postcss] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const TsconfigPathsPlugin = __turbopack_context__.r("[project]/node_modules/enhanced-resolve/lib/TsconfigPathsPlugin.js [postcss] (ecmascript)");
...
"[project]/node_modules/enhanced-resolve/lib/index.js [postcss] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
module.exports = mergeExports(resolve, {
    ...
    get TsconfigPathsPlugin () {
        return __turbopack_context__.r("[project]/node_modules/enhanced-resolve/lib/TsconfigPathsPlugin.js [postcss] (ecmascript)");
    },
    get forEachBail () {
...
//# sourceMappingURL=node_modules_enhanced-resolve_lib_ecdcd880._.js.map